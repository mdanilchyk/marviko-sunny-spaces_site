...
export const SEO_BY_PATH: Record<SeoPath, SeoMeta> = {
  ...
  "/doors-pvh": {
    title: "Надёжные двери ПВХ для дома и офиса — установка в Минске | Марвико",
    description:
      "Входные, балконные и раздвижные двери ПВХ. Бесплатный замер, установка под ключ, гарантия 10 лет. Звоните: " + phone,
    canonical: canonical("/doors-pvh"),
    ogTitle: "Надёжные двери ПВХ для дома и офиса — Марвико",
    ogDescription: "Входные, балконные и раздвижные двери ПВХ. Бесплатный замер, установка под ключ.",
  },
  "/doors-alu": {
    title: "Надёжные алюминиевые двери для дома и офиса — установка в Минске | Марвико",
    description:
      "Входные алюминиевые двери. Бесплатный замер, установка под ключ, гарантия 10 лет. Звоните: " + phone,
    canonical: canonical("/doors-alu"),
    ogTitle: "Надёжные алюминиевые двери для дома и офиса — Марвико",
    ogDescription: "Входные алюминиевые двери. Бесплатный замер, установка под ключ.",
  },
  "/partitions": {
