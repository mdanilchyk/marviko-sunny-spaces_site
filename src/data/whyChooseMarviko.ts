...
/**
 * Посадочные страницы окон ПВХ (/windows-pvh) — конкретные параметры по бланкам.
 */
...
/**
 * Алюминиевые окна (/windows-alu) — без ПВХ-параметров (армирование, фурнитура Accado/UPT/MACO).
 */
export const whyChooseWindowsAluItems: WhyChooseItem[] = [
  {
    icon: Shield,
    title: "Гарантия 2 года",
    desc: "На изделия и монтаж алюминиевых конструкций",
  },
  {
    icon: Award,
    title: "Алюминиевые профильные системы",
    desc: "Качественные алюминиевые конструкции для дома и коммерческих объектов",
  },
  {
    icon: Wrench,
    title: "Стандартные цвета",
    desc: "Белый, серый, коричневый — другие цвета по согласованию",
  },
  {
    icon: Clock,
    title: "Изготовление за 35 рабочих дней",
    desc: "Сертифицированное производство в г. Червень. Монтажники с опытом от 10 лет. Бесплатный выезд замерщика",
  },
];

/** Страницы дверей ПВХ — 4-я карточка «Бесплатный замер». */
...
export const whyChooseDoorsAluItems: WhyChooseItem[] = [
  { icon: Shield, title: "Гарантия 2 года", desc: "На изделия и монтаж алюминиевых конструкций" },
  { icon: Clock, title: "Изготовление за 35 рабочих дней", desc: "Сертифицированное производство в г. Червень. Бесплатный выезд замерщика" },
  { icon: Award, title: "Алюминиевые профильные системы", desc: "Прочные входные системы для дома и коммерческих объектов" },
  { icon: Ruler, title: "Бесплатный замер", desc: "Бесплатный выезд замерщика в удобное время" },
];
