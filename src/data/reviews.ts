...
export const reviews = [
  ...
  },
  {
    ...
    date: "2025",
    text: "Выражаю благодарность директору «Марвико» Кочеву и нач. производства Кочеву за профессионалов, которые изготавливали и устанавливали нам пластиковые окна и двери; менеджерам Ивановой и Бобровской Е. за дизайнерский подход по оформлению пластиковых дверей. Отдельно благодарю монтажника Грибовича В. за его «золотые руки» и мастера своего дела. Работники тактичные, вежливые, заслуживают доверия. На заданный вопрос дают профессиональный ответ. Всё сделано в срок и качественно. Здоровья вам, мира, добра и всех благ!",
    rating: 5,
...
export const windowsPageReviews: Review[] = [
  ...
  reviews[5], // Пуховичский РГС (Минскоблгаз)
  reviews[7], // Денисевич И.
  reviews[8], // Радкевич Л.И.
  reviews[9], // ООО «ДСД-СтройИнвест»
  reviews[10], // УП «Нефтебитумный завод»
];
