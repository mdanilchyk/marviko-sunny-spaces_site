...
export const faqData: FaqItem[] = [
  ...
  {
    q: "Есть ли гарантия на алюминиевые конструкции?",
    a: "Да, на алюминиевые конструкции — гарантия 2 года. Срок изготовления алюминиевых конструкций — 35 рабочих дней.",
  },
...
export const windowsPvhFaq: FaqItem[] = faqData.filter(
  (item) => item.q !== "Есть ли гарантия на алюминиевые конструкции?",
);

/** 3 вопроса — /windows-alu */
export const windowsAluFaq: FaqItem[] = pickFaqByQuestions([
  "Как выбрать стеклопакет?",
  "Есть ли гарантия на алюминиевые конструкции?",
...
/** 2 вопроса — /doors-alu */
export const doorsAluFaq: FaqItem[] = pickFaqByQuestions([
  "Есть ли гарантия на алюминиевые конструкции?",
  "Вы работаете за пределами Червеня?",
]);
...
export function getFaqForPath(path: string): FaqItem[] | null {
  ...
  if (path === "/doors-pvh") return doorsPageFaq;
  if (path === "/doors-alu") return doorsAluFaq;
  return null;
}
