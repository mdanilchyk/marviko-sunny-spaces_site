...
export const WINDOW_PROFILE_PRICING: WindowProfilePricing[] = [
  {
    ...
    prices: [
      { type: "single", title: "Одностворчатое", size: "1400×800", price: "302 BYN" },
      { type: "double", title: "Двустворчатое", size: "1400×1300", price: "395 BYN" },
      { type: "triple", title: "Трёхстворчатое", size: "1400×2000", price: "535 BYN" },
      { type: "balcony", title: "Балконный блок", size: "2100×1500", price: "590 BYN" },
    ],
  ...
  },
  {
    ...
    prices: [
      { type: "single", title: "Одностворчатое", size: "1400×800", price: "315 BYN" },
      { type: "double", title: "Двустворчатое", size: "1400×1300", price: "414 BYN" },
      { type: "triple", title: "Трёхстворчатое", size: "1400×2000", price: "565 BYN" },
      { type: "balcony", title: "Балконный блок", size: "2100×1500", price: "625 BYN" },
    ],
