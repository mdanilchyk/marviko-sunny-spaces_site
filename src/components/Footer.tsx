...
const ViberIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    <path d="M11.4 0C9.5.1 5.4.4 3.2 2.4.6 4.8.2 8.3.1 12.4c-.1 4.1-.2 11.8 7.2 14h.1l-.1 3.2s-.1.9.6 1.1c.8.3 1.2-.5 2-1.3.4-.5 1-1.1 1.4-1.6 3.9.3 6.9-.4 7.2-.5.8-.2 5.2-.8 5.9-6.6.8-6-1-9.8-1-9.8S22.1.5 11.4 0zm1.3 21.3c-3.3-.3-5.8.3-5.8.3l-2 2.4c0-.1.1-5.5.1-5.5C.9 16.3 1.1 9.9 1.2 7.1c.1-2.8.5-5.3 2.4-7.1C5.6-1.6 9.5-1 11.2-.9c9.3.4 10.4 4.3 10.6 4.7 0 0 1.5 3.3.8 8.5-.6 5-4.3 5.5-4.9 5.7-.3.1-2.8.7-5.8.4h-.2v2.9zm5.3-9.4c-.1.8-.6 1.5-1.3 1.9-.6.3-1.2.4-1.8.3-.4-.1-.5-.1-.5-.1l-.5-.2c-1.5-.6-2.8-1.5-3.8-2.7-.5-.5-.9-1.1-1.2-1.7-.3-.6-.6-1.3-.6-1.3-.2-.5-.1-1.1.2-1.5.3-.4.7-.7 1.2-.8.3 0 .5 0 .7.2.2.2.5.8.7 1.1.2.3.4.7.1 1.1-.2.3-.5.5-.5.5s.1.5.6 1.1c.4.5.8.8.8.8s.2-.3.5-.5c.4-.3.8-.1 1.1.1.3.2.9.5 1.1.7.2.2.2.4.2.7z" />
  </svg>
);
