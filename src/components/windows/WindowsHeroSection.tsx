...
const WindowsHeroSection = ({ hero }: WindowsHeroSectionProps) => (
  <section
    id="hero"
    className="dark-section relative flex flex-col justify-start lg:justify-center min-h-0 lg:min-h-[calc(100dvh-7rem)] py-4 sm:py-10 lg:py-16"
  ...
  >
    ...
    <div className="container mx-auto section-padding relative z-10">
      <div className="flex flex-col gap-3 sm:gap-4 lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
        <AnimatedSection className="order-1">
          <SectionLabel>{hero.label}</SectionLabel>
          <h1 className="text-[1.625rem] leading-[1.15] sm:text-4xl lg:text-5xl text-display mb-0 sm:mb-2 max-w-2xl">
            {hero.title}
          </h1>
        </AnimatedSection>
